...
#### 2. Tumbling, Hopping, Sliding, Session windows
...
#### 3. Sliding - fixed size that 'roll' continuously with time (special, only for joins)

#### 4. Session - growing windows that close after a period of inactivity
